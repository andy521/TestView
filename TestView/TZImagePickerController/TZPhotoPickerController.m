...
- (void)configBottomToolBar {
    TZImagePickerController *tzImagePickerVc = (TZImagePickerController *)self.navigationController;
    UIView *bottomToolBar = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.tz_height -hight- 50, self.view.tz_width, 50)];
    ...
    if (tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        _originalPhotoButton.frame = CGRectMake(50, 5, 130, 50);
    ...
    _okButton.frame = CGRectMake(self.view.tz_width - 120 - 20, 3, 120, 44);
    _okButton.titleLabel.font = [UIFont systemFontOfSize:16];
    _okButton.backgroundColor = [UIColor redColor];
    _okButton.layer.masksToBounds = YES;
    _okButton.layer.cornerRadius = 15;
        ...
        if (isSelected) {
            ...
            for (TZAssetModel *model_item in selectedModels) {
                if ([model.asset isEqual:model_item.asset]) {
                    ...
                    //[model_item.selectButton setTitle:@"" forState:UIControlStateNormal];
//                }else
//                {
//                    [model_item.selectButton setTitle:[NSString stringWithFormat:@"%ld",(long)[tzImagePickerVc.selectedModels indexOfObject:model_item]+1] forState:UIControlStateNormal];
//                }
            }
            //改变数字
//            NSMutableArray *selectedMutArr = [NSMutableArray arrayWithArray:_selectButtonArray];
//            NSArray *selectedArray = [NSArray arrayWithArray:selectedMutArr];
//
//            for(UIButton *selectedBtn in selectedArray)
//            {
//                if([selectedBtn.currentTitle isEqualToString:weakCell.selectPhotoButton.currentTitle])
//                {
//                    [selectedMutArr removeObject:selectedBtn];
//                }else
//                {
//                    [selectedBtn setTitle:[NSString stringWithFormat:@"%ld",(long)[selectedMutArr indexOfObject:selectedBtn]+1] forState:UIControlStateNormal];
//                }
//            }
            ...
            if (tzImagePickerVc.selectedModels.count < tzImagePickerVc.maxImagesCount) {
                ...
                model.selectButton = weakCell.selectPhotoButton;
                [tzImagePickerVc.selectedModels addObject:model];
                //数字
               // [_selectButtonArray addObject:weakCell.selectPhotoButton];
               // [weakCell.selectPhotoButton setTitle:[NSString stringWithFormat:@"%ld",(long)tzImagePickerVc.selectedModels.count] forState:UIControlStateNormal];
                [weakSelf refreshBottomToolBarStatus];
            } else {
...
- (void)refreshBottomToolBarStatus {
    ...
    [_okButton setTitle: [NSString stringWithFormat:@"完成 (%ld)",(long)imagePickerVc.selectedModels.count] forState:UIControlStateNormal];

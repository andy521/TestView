...
//    {
//         [self.selectPhotoButton setTitle:model.selectButton.currentTitle forState:UIControlStateNormal];
//        self.selectPhotoButton.frame = CGRectMake(self.tz_width - 27, 2, 25, 25);
//        self.selectPhotoButton.backgroundColor = visualThemeColor;
//        self.selectPhotoButton.layer.cornerRadius = 25/2;
...
//        self.selectImageView.image =  [UIImage imageNamedFromMyBundle:@"photo_def_photoPickerVc.png"];
//    }
...
//    {
//        sender.frame = CGRectMake(self.tz_width - 27, 2, 25, 25);
//        sender.backgroundColor = visualThemeColor;
//        sender.layer.cornerRadius = 25/2;
...
- (UILabel *)titleLable {
    if (_titleLable == nil) {
        ...
        titleLable.frame = CGRectMake(80, 0, self.tz_width - 80 - 50, 70);
